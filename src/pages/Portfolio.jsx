                ...
                <div className="w-full h-full bg-projectBackground bg-cover bg-center rounded-lg">
                    <div className="w-full h-full rounded-lg bg-shadow flex flex-col">
                        <div className="flex-1 w-full rounded-t-lg flex items-center">
                            ...
                            <div className="flex-[2] h-full rounded-tr-lg bg-projectMojaveBackground bg-cover bg-center">
                        ...
                        <div className="flex-1 w-full flex items-center">
                            <div className="flex-1 h-full bg-projectKanbanBackground bg-cover bg-center">
                                <ProjectsContent id='kanban'/>
                            </div>
                            <div className="flex-1 h-full bg-projectTokpedBackground bg-cover bg-center">
                        ...
                        <div className="flex-1 w-full rounded-b-lg flex items-center">
                            <div className="flex-1 h-full"></div>
                            <div className="flex-1 h-full bg-projectGacoanBackground bg-cover bg-center">
